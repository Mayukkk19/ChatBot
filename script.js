...
async function chatbot(input) {
    ...
    const responses = {
        ...
        shoping: ["I want to shoping","best shoping website","shoping","amazon"],
        webseries: ["I want to watch webseries","start netflix","want to show webseries","netflix","play netflix","webseries website"],
        weather: ["can you tell the weather report of","weather", "today's weather", "what's the weather like", "tell me the weather", "how's the weather", "what's the forecast"],
